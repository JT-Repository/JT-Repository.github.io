...
<html lang="en-GB">
<head>
<title>muneo - bespoke responsive website solutions - about muneo</title>
<meta charset="utf-8" />
<meta http-equiv="x-ua-compatible" content="ie=edge, chrome=1" />
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
<meta name="keywords" content="">
<meta name="description" content="muneo specialise in the design and build of bespoke responsive website solutions. We are passionate about creating quality hand-crafted responsive websites.">
...
<link rel="canonical" href="http://www.muneo.co.uk/about.php" />
...
<header class="header">
    ...
    <nav class="nav">
        <ul class="nav-list">
            <li class="nav-item current"><a class="about" href="about.php" title="">about<span>muneo</span></a></li>
...
<div class="row">
    ...
    <div class="responsive-full-width">
        <div class="inflated">
            ...
            <h1>about <strong>muneo</strong></h1>
            
            <h2><em>muneo</em> <strong>website solutions</strong> is a UK based web design consultancy with many years of design experience, providing professional website solutions to many businesses throughout the UK.</h2>
            
            <div class="guarantee"></div>
            
            <p>We specialise in the design and build of bespoke responsive website solutions and our packages are aimed primarily at small to medium-sized businesses.</p>
            
            <p>We are professional, friendly and, more importantly, passionate about creating quality hand-crafted responsive websites for our clients. We can draw upon many years of experience and guarantee that each and every one of <strong>our websites are delivered to the same exacting standards</strong> - so you can rest assured that your site is in safe hands.</p>
            
            <p>We take great pride in the quality of our websites and offer a 'continued' high standard of support to all of our valued clients. <strong>We are confident that should you decide to use <em>muneo</em> you will be delighted with results.</strong></p>
